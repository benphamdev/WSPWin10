...
public class Tho {
	...
	public Tho(String matho, String hotentho, String phai, String manhomtho) {
		this.matho = matho;
	...
	public String toString() {
		return "Thợ mã thợ : " + matho + ", họ và tên : " + hotentho + ", phái : "
				+ phai + ", mã nhóm thợ : " + manhomtho + ", nhóm thợ : " + nhomtho
				+ "]";
	}
}
